...
Read clicks and average position only as a pair. Impressions with no clicks at a decent position is a title and snippet problem. Rewriting the body is then the wrong afternoon of work, because the reader never got as far as the body to be disappointed by it.
...
- **Reading the graphs every day.** At these volumes two days can swing further apart than a real week of change. I shipped a fix on a Tuesday dip and reverted it on Friday, more than once, and neither the fix nor the revert had anything to do with the numbers that moved.
