...
Here is what that feed had. Otter on the Pro plan cuts a single recording off at 90 minutes. This is not a malfunction — it is written in their own price list, and four hours per recording only arrives one tier up.
...
<figure>
  ...
  />
  <figcaption>
    Otter pricing, read on 13 August 2026. Prices shown are the annual rate. The 90 minutes is a line in the price list, not a bug — and the two reviews below are people leaving over that line.
  </figcaption>
</figure>
