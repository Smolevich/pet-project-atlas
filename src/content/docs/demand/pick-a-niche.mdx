...
That is normal. Somebody took the niche, and that does not mean they did it well. People rarely do it well.

Almost anyone can put a product together now. Writing the code got cheap. Two other things got hard. People have to find you, and you have to explain how you are better.
...
A pet project is what you build outside your job and outside somebody else's plan. You decide what to do. That does not mean you may not take money.

Money spoils nothing. If anything, the reverse. People use free things happily, and that tells you nothing. One person who pays says more about the product than a hundred who signed up.
...
And if somebody is working in the niche, the demand is already there. Somebody before you proved the job is real and that money changes hands over it.

From there it is simple. Every working competitor has at least one thing done badly. It irritates the people who pay him, too.

A paying customer is the most patient person of all. He spent money and does not want to admit it was wasted. If he still sat down to write a review, something really got to him.
...
Fifty reviews to a page, around nine pages, then nothing. Every review carries a date, a rating and the app version. The version tells you which release the complaints started on. You change the country right in the address — `gb`, `fr` and `de` complain about different things.

Here is what I found there. Otter on the paid Pro plan cuts a recording off at 90 minutes. That is not a fault: it is written in their price list. Four hours only come one tier up.
...
**Count them, do not scroll them.** I downloaded that app's whole feed. It came to 209 one- and two-star reviews, from 16 September 2024 to 3 August 2026. Money and limits: 118 reviews. The bot mixing up who is speaking: 11.

And I had been sure the main pain here was "which of them is talking now". Among paying users that pain loses to money ten to one. I could have found this out in ten minutes.
...
**And this part stopped being free.** The advice about it is usually out of date. Reddit no longer reads from a script: without OAuth the feed returns 403. Search on X is prepaid now. G2 and Capterra banned headless browsers outright in their 2026 terms — reading by hand is fine, automating is not.

### What "features first" actually costs

Now my numbers. And my own mistake in how I read them.

Between 12 May and 14 August, 253 people signed up to the bot. **83 of them did nothing at all** — not one row in the events table.

For three months I read that as "there is no demand". Then I split it by date.

Before 17 July the starting grant was not credited to new users. Somebody arrived, had zero credits, and could do nothing at all. That was my bug, not the market.

| When they arrived | Total | Did nothing |
|---|---|---|
| before 17 July, grant not credited | 70 | 56 (80%) |
| after 17 July, grant works | 183 | 27 (15%) |

And the other half of the same story. The feedback button sat in the bot the whole time. In three months nine people used it. Nobody wrote to say the product did not work.

So silence in your data is not a verdict on demand. Check first whether the product was even working.

Now the people it did work for. 155 got a result at least once, and **117 of them used it for one day**.

Three users reached the end of the free allowance. One tried again, nobody paid. The lowest balance is 16 credits, the average is 209.
...
Say it out loud before the first line of code. If it will not come out, you have no difference yet. Better to find that out now than at your three hundredth user.
...
- **Reading silence as an absence of demand.** 83 people out of 253 pressed nothing. For three months I took that as a verdict on the niche. For 56 of them it was my bug: zero credits.
...
- **Treating a signup as a signal.** The signups looked like an audience. Of the people the product actually worked for, 117 came exactly once.
