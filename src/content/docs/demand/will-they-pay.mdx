...
Start here: this check costs nothing and takes a minute. Run your main query and read who is standing on the results page. If a product with a pricing page sits in the top ten, somebody already tested this market with their own money, and you do not have to repeat their research.

```
site:example.com pricing
```

Read their price the same way. Write down the shape rather than the number: per seat, per action, per month, a free tier with a wall inside it. You will put your own figure there anyway, and the shape tells you what people here pay for at all.
