...
- **Trusting my own notes from last time**. A re-check months later contradicted them both ways: hosts I had recorded as dead were serving again, and one venue I submitted to had gone, so that listing never existed.
