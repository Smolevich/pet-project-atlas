...
Move the default engine to the cheap one before you take money — [what one user costs](/money/unit-economics/). The first payer arrives on the default path. If that path runs your expensive engine, the first sale spends the very margin the sale was meant to prove.
...
- Say the price out loud with its unit attached. If your rows do not record that unit, you cannot check the price against cost.
...
If the refusals name the free path rather than the number, the problem sits upstream of the price. Read [whether that audience pays](/demand/will-they-pay/).
