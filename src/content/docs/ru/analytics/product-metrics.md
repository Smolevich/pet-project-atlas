...
Вот моя таблица. Она проваливает и стоимость, и источник, замер 13 августа 2026-го, а в `usage_events` 1180 строк начиная с 13 мая. Колонок, в имени которых есть `cost` или `price`, — ноль. Колонок с источником — ноль.
