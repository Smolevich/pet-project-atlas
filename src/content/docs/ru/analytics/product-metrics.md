...
`user_id` — стабильный внутренний id. Сессии кончаются, а спрашивать вы будете про человека. `name` берётся из закрытого списка в коде. `outcome` хранит `ok` или названный класс ошибки. Булев флаг выбрасывает ту часть падения, с которой можно работать.
