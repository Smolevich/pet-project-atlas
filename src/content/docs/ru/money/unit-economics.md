...
Формулы держите в коде, а не в ячейках таблицы: тогда известные входы становятся юнит-тестами, а протянутая мышью ячейка не перепишет модель без предупреждения.
